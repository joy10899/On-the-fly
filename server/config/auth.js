...
const options = {
    ...
    callbackURL: `${process.env.API_URL || 'https://server-myn0.onrender.com/'}/auth/github/callback`
}
        ...
        if(!user){
            const results = await pool.query(
                `INSERT INTO users (githubid, username, avatarurl, accesstoken)
                 VALUES($1,$2,$3,$4) RETURNING *`,[userData.githubId, userData.username, userData.avatarUrl, userData.accessToken]
            )
